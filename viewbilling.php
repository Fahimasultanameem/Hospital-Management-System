...
<h2>Search Billing Records - <input type="search" class="light-table-filter" data-table="order-table" placeholder="Filtrer" /></h2>
...
if($rs[bill_type]  == "Prescription charge")
{
	...
	echo " </td><td>&nbsp;BDT. $rs[bill_amount]</td></tr>";
    ...
    <table width="557" border="3">
      <tbody>
        <tr>
          ...
          <td>&nbsp;BDT. <?php echo $billamt; ?></td>
        </tr>
        <tr>
          <th width="442" scope="col"><div align="right">Tax Amount (5%) &nbsp; </div></th>
          	<td width="95">&nbsp;BDT. <?php echo $taxamt = 5 * ($billamt / 100); ?>
            </td>
        </tr>
         
		<tr>
		  <th scope="col"><div align="right">Discount &nbsp; </div></th>
		  <td>&nbsp;BDT. <?php echo $rsbilling_records[discount]; ?></td>
	    </tr>
        
		<tr>
		  <th scope="col"><div align="right">Grand Total &nbsp; </div></th>
		  <td>&nbsp;BDT. <?php echo ($billamt + $taxamt)  - $rsbilling_records[discount] ; ?></td>
	    </tr>
      </tbody>
    </table>
