...
?>
  &nbsp;BDT. <?php echo $billamt; ?></td>
		...
		<tr>
		  ...
		  <td>&nbsp;BDT. <?php echo $grandtotal = ($billamt + $taxamt)  - $rsbilling_records[discount] ; ?></td>
	    </tr>
		<tr>
		...
		<tr>
		  ...
		  <td>BDT. <?php echo $balanceamt = $grandtotal - $rspayment[0]  ; ?></td>
	    </tr>
      </tbody>
    </table>
...
<?php       
		...
		?>
			   <tr>
				 ...
				 <td>&nbsp;BDT. <?php echo $rspayment[paidamount]; ?></td>
			   </tr>
		<?php
		}
?>
